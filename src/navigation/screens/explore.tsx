...
export default function App() {
  ...
  const handleRetake = () => {
    setPictureUri(null);
    setPrediction(null);
    setShowCamera(true); // Muestra nuevamente la cámara
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      {!showCamera && pictureUri && (
        <>
          ...
          <Button title="Guardar y Predecir" onPress={predictImage} color="#27ae60" />
          <Button title="Reintentar" onPress={handleRetake} color="#f39c12" />
